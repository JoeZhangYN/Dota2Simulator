...
namespace TestKeyboard.DriverStageHelper
{
    public class SendInputHelper
    {
        ...
        const int KeyEvent_InputType = 1; // INPUT 键盘类型 1

        const int KeyEvent_KeyDown = 0; // Key Down
        const int KeyEvent_KeyUp = 0x0002; // Key Up

        const int KeyEvent_EXTENDEDKEY = 0x0001;
        const int KeyEvent_UNICODE = 0x0004;
        const int KeyEvent_SCANCODE = 0x0008; // SCANCODE

        const int MouseEvent_InputType = 0; // INPUT 鼠标类型 0
