...
internal partial class Form2 : Form
{
    ...
    private async void Hook_KeyDown(object sender, KeyEventArgs e)
    {
        ...
        switch (tb_name.Text.Trim())
        {
            ...
            case "海民":
            {
                ...
                switch (e.KeyCode)
                {
                    ...
                    case Keys.E:
                        ...
                        break;
                    case Keys.F:
                        if (_命石选择 == 1) DOTA2释放CD就绪技能(Keys.E, in _全局数组);
            ...
            case "夜魔":
            {
                ...
                {
                    case Keys.F1:
                        if (_是否魔晶) _切假腿配置.修改配置(Keys.E, true);
            ...
            case "钢背":
            {
                ...
                {
                    case Keys.F1:
                        if (_是否魔晶) _切假腿配置.修改配置(Keys.D, true);

                        if (_是否神杖) _切假腿配置.修改配置(Keys.E, true);
            ...
            case "小骷髅":
            {
                ...
                {
                    case Keys.F1:
                        if (_是否魔晶) _切假腿配置.修改配置(Keys.D, true, "敏捷");

                        if (_是否神杖) _切假腿配置.修改配置(Keys.F, true);
                ...
                switch (e.KeyCode)
                {
                    case Keys.F1:
                        _全局模式e = ColorAEqualColorB(获取指定位置颜色(738, 957, in _全局数组),
                            ...
                            ? 1
                            : 0;
                        if (_是否魔晶) _切假腿配置.修改配置(Keys.F, true);
            ...
            case "猴子":
            {
                ...
                {
                    case Keys.Q:
                        if (!DOTA2判断状态技能是否启动(Keys.E, in _全局数组)) SimKeyBoard.KeyPress(Keys.E);
            ...
            case "血魔":
            {
                ...
                if (e.KeyValue == (int)Keys.Q && (int)e.Modifiers == (int)Keys.Alt) _条件3 = true;
            ...
            case "光法":
            {
                ...
                if (e.KeyValue == (int)Keys.E && (int)e.Modifiers == (int)Keys.Alt) _条件4 = true;
            ...
            case "墨客":
            {
                ...
                if (e.KeyValue == (int)Keys.E && (int)e.Modifiers == (int)Keys.Alt) _条件3 = true;
            ...
            case "巫妖":
            {
                ...
                if (e.KeyValue == (int)Keys.W && (int)e.Modifiers == (int)Keys.Alt) _条件2 = true;
            ...
            case "帕克":
            {
                ...
                if (e.KeyValue == (int)Keys.W && (int)e.Modifiers == (int)Keys.Control) _条件2 = true;
            ...
            case "暗影萨满":
            {
                ...
                switch (e.KeyCode)
                {
                    case Keys.Q:
                        ...
                        break;
                    case Keys.W:
                        if (RegPicture(物品_祭礼长袍_数组, _全局数组)) _状态抗性倍数 *= 1.1;

                        if (RegPicture(物品_永恒遗物_数组, _全局数组)) _状态抗性倍数 *= 1.2;
            ...
            case "奶绿":
            {
                ...
                {
                    case Keys.F1:
                        if (_是否神杖) _切假腿配置.修改配置(Keys.D, true);
                ...
                switch (e.KeyCode)
                {
                    ...
                    case Keys.E:
                        ...
                        if (ColorAEqualColorB(获取指定位置颜色(971, 1008, in _全局数组), 技能点颜色, 0))
                            ...
                            _全局时间 = 5000;
                        else if (ColorAEqualColorB(获取指定位置颜色(935, 1008, in _全局数组), 技能点颜色, 0)) _全局时间 = 4000;
    ...
    private static async Task 根据按键判断技能释放前通用逻辑(KeyEventArgs e)
    {
        ...
        switch (e.KeyCode)
        {
            ...
            default:
                ...
                if (按键匹配条件更新.TryGetValue(e.KeyCode, out Action value)) value.Invoke();
                break;
        }
    ...
    {
        if (DOTA2对比释放技能前后颜色(skill, _全局数组)) return await FromResult(true).ConfigureAwait(true);
    ...
    {
        if (DOTA2判断技能是否CD(skill, _全局数组)) return await FromResult(true).ConfigureAwait(true);
    ...
    {
        if (DOTA2判断法球技能是否CD(skill, in _全局数组)) return await FromResult(true).ConfigureAwait(true);
    ...
    {
        if (!DOTA2判断状态技能是否启动(skill, _全局数组)) return await FromResult(true).ConfigureAwait(true);
    ...
    {
        if (DOTA2判断任意物品是否锁闭(in 数组)) return await FromResult(true).ConfigureAwait(true);
    ...
    {
        if (DOTA2判断序号物品是否CD(序号, in 数组)) return await FromResult(true).ConfigureAwait(true);
    ...
    private static async Task<bool> 牺牲去后摇(字节数组包含长宽 数组)
    {
        return await 主动技能释放后续(Keys.R, () =>
        {
            ...
            if (DOTA2释放CD就绪技能(Keys.Q, in 数组)) return;
    ...
    {
        if (_命石选择 == 0) _命石选择 = RegPicture(命石_海民_酒友_数组, in _全局数组, 15) ? 2 : 1;
    ...
    private static async Task<bool> 钩子去僵直(字节数组包含长宽 数组)
    {
        ...
        {
            if (!DOTA2判断状态技能是否启动(Keys.W, in 数组)) SimKeyBoard.KeyPress(Keys.W);

            SimKeyBoard.KeyPress(Keys.A);
            if (_全局模式q == 1) _条件3 = true;
        }).ConfigureAwait(true);
    }
    ...
    private static async Task<bool> 吼去后摇(字节数组包含长宽 数组)
    {
        return await 主动技能释放后续(Keys.Q, () =>
        {
            if (_全局模式q == 1) _ = 根据图片使用物品(物品_刃甲_数组);
            // 触发激怒
            SimKeyBoard.KeyPress(Keys.A);
            SimKeyBoard.KeyPress(Keys.W);
        }).ConfigureAwait(true);
    ...
    {
        if (根据图片使用物品(物品_魂戒_数组) == 1) Delay(等待延迟);
    ...
    private static async Task<bool> 热血竞技场去后摇(字节数组包含长宽 数组)
    {
        return await 主动技能释放后续(Keys.R, () =>
        {
            if (判断技能状态(Keys.E, 数组, 技能类型.状态)) SimKeyBoard.KeyPress(Keys.E);
    ...
    private static async Task<bool> 如影随形去后摇(字节数组包含长宽 数组)
    {
        return await 主动技能释放后续(Keys.R, () =>
        {
            if (_全局模式f == 1) SimKeyBoard.KeyPress(Keys.D);
        }).ConfigureAwait(true);
    }
    ...
    private static async Task<bool> 空降去后摇(字节数组包含长宽 数组)
    {
        return await 主动技能进入CD后续(Keys.D, () =>
        {
            if (_全局模式f == 1)
            {
                if (根据图片使用物品(物品_幻影斧_数组) == 1) 分身一齐攻击();
                Delay(33 * 根据图片使用物品(物品_否决_数组));
                Delay(33 * 根据图片使用物品(物品_紫苑_数组));
                Delay(33 * 根据图片使用物品(物品_血棘_数组));
            }
    ...
    private static async Task<bool> 无影拳后续处理(字节数组包含长宽 数组)
    {
        ...
        if (b)
        {
            if (_全局模式w == 1) SimKeyBoard.KeyPress(Keys.Q);
    ...
    private static async Task<bool> 血祭去后摇(字节数组包含长宽 数组)
    {
        return await 主动技能释放后续(Keys.W, () =>
        {
            ...
            if (DOTA2释放CD就绪技能(Keys.Q, in 数组)) SimKeyBoard.MouseMove(p);
        }).ConfigureAwait(true);
    }
    ...
    private static async Task<bool> 天怒秒人连招(字节数组包含长宽 数组)
    {
        ...
        {
            case < 2:
                if (DOTA2释放CD就绪技能(Keys.W, in 数组)) return await FromResult(true).ConfigureAwait(true);

                if (DOTA2释放CD就绪技能(Keys.E, in 数组)) return await FromResult(true).ConfigureAwait(true);

                if (DOTA2释放CD就绪技能(Keys.Q, in 数组)) return await FromResult(true).ConfigureAwait(true);
            ...
            case < 3:
            {
                if (DOTA2释放CD就绪技能(Keys.R, in 数组)) return await FromResult(true).ConfigureAwait(true);
    ...
    private static async Task<bool> 幻象法球去后摇(字节数组包含长宽 数组)
    {
        return await 主动技能进入CD后续(Keys.Q, () =>
        {
            设置全局步骤q(1);
            Delay(3400);
            if (_全局模式d == 1) SimKeyBoard.KeyPress(Keys.D);
            设置全局步骤q(0);
        }).ConfigureAwait(true);
    }
    ...
    private static async Task<bool> 生命吸取去后摇(字节数组包含长宽 数组)
    {
        ...
        return await Run(async () =>
        {
            if (_全局步骤r == 0)
            {
                if (_全局模式r == 1) SimKeyBoard.KeyPress(Keys.W);
    ...
    private static async Task<bool> 关接陨星锤(字节数组包含长宽 数组)
    {
        ...
        if (ColorAEqualColorB(获取指定位置颜色(909, 1008, in 数组), 技能点颜色, 0))
            time = 4000;
        else if (ColorAEqualColorB(获取指定位置颜色(897, 1008, in 数组), 技能点颜色, 0)) time = 3250;
        ...
        static void 关后(int time, in 字节数组包含长宽 数组)
        {
            ...
            if (!_中断条件) _ = 根据图片使用物品(物品_陨星锤_数组);
        }

        if (DOTA2判断技能是否CD(Keys.W, in 数组)) return await FromResult(true).ConfigureAwait(true);
    ...
    private static async Task<bool> 神智之蚀去后摇(字节数组包含长宽 数组)
    {
        ...
        if (DOTA2判断技能是否CD(Keys.R, in 数组)) return await FromResult(true).ConfigureAwait(true);
    ...
    private static async Task<bool> 龙破斩去后摇(字节数组包含长宽 数组)
    {
        ...
        if (DOTA2判断技能是否CD(Keys.Q, in 数组)) return await FromResult(true).ConfigureAwait(true);
    ...
    private static async Task<bool> 闪电风暴去后摇(字节数组包含长宽 数组)
    {
        ...
        if (DOTA2判断技能是否CD(Keys.E, in 数组)) return await FromResult(true).ConfigureAwait(true);
    ...
    private static async Task<bool> 虚无主义去后摇(字节数组包含长宽 数组)
    {
        ...
        if (DOTA2判断技能是否CD(Keys.D, in 数组)) return await FromResult(true).ConfigureAwait(true);
        ...
        static void 萨满变羊后(字节数组包含长宽 数组)
        {
            ...
            Run(() =>
            {
                ...
                if (ColorAEqualColorB(获取指定位置颜色(909, 1008, in 数组), 技能点颜色, 0))
                    ...
                    time = 1900;
                else if (ColorAEqualColorB(获取指定位置颜色(875, 1008, in 数组), 技能点颜色, 0)) time = 1150;
    ...
    private static async Task<bool> 羊刺刷新秒人(字节数组包含长宽 数组)
    {
        ...
        if (步骤 == 1)
        {
            if (根据图片使用物品(物品_奥术鞋_数组) == 1) return await FromResult(true).ConfigureAwait(true);

            if (根据图片使用物品(物品_魂戒_数组) == 1) return await FromResult(true).ConfigureAwait(true);
        ...
        {
            if (根据图片使用物品(物品_跳刀_数组) == 1) return await FromResult(true).ConfigureAwait(true);

            if (根据图片使用物品(物品_跳刀_智力跳刀_数组) == 1) return await FromResult(true).ConfigureAwait(true);
    ...
    private static async Task<bool> 吹风接冰封路径(字节数组包含长宽 数组)
    {
        ...
        if (!RegPicture(物品_吹风_数组, in 数组) && _全局时间 == -1) 初始化全局时间(ref _全局时间);

        if (获取当前时间毫秒() - _全局时间 < 2500 - 650 - 600) return await FromResult(true).ConfigureAwait(true);
    ...
    private static async Task<bool> 烈火护盾去后摇(字节数组包含长宽 数组)
    {
        ...
        if (DOTA2判断技能是否CD(Keys.F, in 数组)) return await FromResult(true).ConfigureAwait(true);
    ...
    private static async Task<bool> 复仇接穿刺(字节数组包含长宽 数组)
    {
        ...
        else
        {
            ...
            if (大招状态) return await FromResult(true).ConfigureAwait(true);

            if (DOTA2释放CD就绪技能(Keys.Q, 数组)) return await FromResult(true).ConfigureAwait(true);
    ...
    private static async Task<bool> 快速选择敌方英雄(int width = 1920, int height = 1080, int type = 0, int type1 = 0)
    {
        ...
        if (type1 == 1) Delay(330); // 基本延迟用于迷雾显示
    ...
    private static async Task 一般程序循环()
    {
        async Task 更新条件(bool[] 条件数组, ConditionDelegateBitmap[] 委托数组)
        {
            ...
            for (int i = 0; i < 条件数组.Length; i++) 条件数组[i] = results[i];
        }
        ...
        while (_总循环条件)
        {
            if (_循环内获取图片 is not null)
            {
                ...
                // 如果有获取命石的委托
                if (_命石根据图片委托 != null) await _命石根据图片委托(_全局数组).ConfigureAwait(true);
                ...
                if (原始数组[0]) _条件1 = 条件数组[0];

                if (原始数组[1]) _条件2 = 条件数组[1];

                if (原始数组[2]) _条件3 = 条件数组[2];

                if (原始数组[3]) _条件4 = 条件数组[3];

                if (原始数组[4]) _条件5 = 条件数组[4];

                if (原始数组[5]) _条件6 = 条件数组[5];

                if (原始数组[6]) _条件7 = 条件数组[6];

                if (原始数组[7]) _条件8 = 条件数组[7];

                if (原始数组[8]) _条件9 = 条件数组[8];

                if (原始数组[9]) _条件z = 条件数组[9];

                if (原始数组[10]) _条件x = 条件数组[10];

                if (原始数组[11]) _条件c = 条件数组[11];

                if (原始数组[12]) _条件v = 条件数组[12];

                if (原始数组[13]) _条件b = 条件数组[13];

                if (原始数组[14]) _条件space = 条件数组[14];

#if DOTA2
                if (_条件保持假腿 && _条件开启切假腿 && _需要切假腿) await 切假腿处理(_条件假腿敏捷 ? "敏捷" : "力量").ConfigureAwait(true);
#endif
            }
    ...
    private static async Task 切假腿处理(string 假腿类型)
    {
        ...
        await Run(async () =>
        {
            ...
            if (RegPicture(数组, in _全局数组)) return;
    ...
    /// <returns></returns>
    private static bool RegPicture(Bitmap bp, in 字节数组包含长宽 数组1, double matchRate = 0.8)
    {
    ...
    private static bool RegPicture(in 字节数组包含长宽 数组1, in 字节数组包含长宽 数组2, double matchRate = 0.8)
    {
    ...
    private static bool RegPicture(in 字节数组包含长宽 数组1, in 字节数组包含长宽 数组2, byte tolerance, double matchRate = 0.8)
    {
    ...
    private static Point RegPicturePoint(Bitmap bp, int x, int y, int width, int height, double matchRate = 0.8)
    {
        try
        {
            Point p = FindPictureParallel(bp, CaptureScreen(x, y, width, height), matchRate: matchRate)[0];
    ...
    private static PooledList<Point> RegPicturePoint(Bitmap bp, in 字节数组包含长宽 数组, double matchRate = 0.8)
    {
        try
        {
    ...
    private static Point RegPicturePointR(in 字节数组包含长宽 数组1, in 字节数组包含长宽 数组2, double matchRate = 0.8)
    {
        try
        {
    ...
    private static Color GetPixelBytes(in 字节数组包含长宽 数组, int x, int y)
    {
    ...
    private static Color GetSPixelBytes(in 字节数组包含长宽 数组, in Point p)
    {
    ...
    private void 测试其他功能()
    {
        ...
        for (int i = 0; i < 200; i++) _ = 获取图片_2().Result;
    ...
    private async Task 测试方法(int x, int y)
    {
        ...
        while (true)
        {
            ...
            数组.字节数组 = await GetBitmapByteAsync(bitmap).ConfigureAwait(true);
    ...
    private static int 获取技能位置偏移(Keys 技能位置, 技能信息 技能信息)
    {
        ...
        if (技能位置 == Keys.F && 技能信息 == 技能5) index = 3; // 6技能魔晶A杖
    ...
    public static int 获取当前技能数量(in 字节数组包含长宽 数组)
    {
        ...
        for (int j = 0; j < 技能列表.Count; j++)
        {
            ...
            for (int i = 0; i < 技能数量[j] - 1; i++) 根据数量判断是否存在技能(in 数组, 当前技能, i, ref count_技能);

            if (count_技能 == 技能数量[j] - 1) return count_技能 + 1;
        }
    ...
    private static bool 获取状态抗性()
    {
        ...
        {
            _状态抗性倍数 = 1;
            if (_form.Controls["tb_状态抗性"] is TextBox tb) Logger.Error($"获取状态抗性异常:{tb.Text.Trim()}");
        }
    ...
    {
        if (_技能数量 == 4 && (技能位置 == Keys.D || 技能位置 == Keys.F)) return false;
    ...
    {
        if (技能数量 == 4 && (技能位置 == Keys.D || 技能位置 == Keys.F)) return Color.Empty;
    ...
    public static bool DOTA2获取单个释放技能前颜色(Keys 技能位置, in 字节数组包含长宽 数组)
    {
        ...
        if (判断是否更新释放技能前颜色(技能位置, 获取技能信息(_技能数量), in 数组)) 更新释放前颜色(技能位置, 获取当前颜色);
    ...
    private static double 获取当前攻击速度()
    {
        ...
        foreach (ColorCheck check in colorChecks)
        {
            ...
            {
                if (_form.Controls["tb_攻速"] is TextBox tb) tb.Text = ocrResult;
    ...
    private static bool 是否无效位置(Point 位置)
    {
    ...
    private static int 获取物品位置序号(Point 位置, 物品信息 物品)
    {
        ...
        if (y - 物品.物品最上侧y >= 物品.物品间隔y) index += 3;
        return index;
    }
    ...
    private static bool 检查技能颜色(in 字节数组包含长宽 数组, int[] xCoords, int yCoord, Color 技能点颜色)
    {
        ...
        foreach (int xCoord in xCoords)
        {
            ...
            if (color_a_equal_color_b(colora, 技能点颜色rgba, 1)) return true;
        }
