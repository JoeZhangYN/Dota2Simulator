...
#pragma warning restore IDE0052
    ...
    public 孽主Strategy(IInputExecutor input, IScreenVision vision, SkillEngine skill, ItemEngine item)
    {
        _input = input;
        _vision = vision;
        _skill = skill;
    ...
    {
        Main._聚合.Conditions[ConditionSlotKey.C1].Probe ??= 火焰风暴去后摇;
        Main._聚合.Conditions[ConditionSlotKey.C2].Probe ??= 怨念深渊去后摇;
    }
