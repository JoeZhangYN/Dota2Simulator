// Phase 12 Chunk 3b: 露娜 Strategy 迁 HeroPlan DSL — 3 helper 全简单一行式, 100% fit Plan.
#if DOTA2
...
/// <summary>露娜（敏捷）策略——迁移自 _main.根据当前英雄增强 的 case "露娜"。Phase 12 C3b: 链式 DSL.</summary>
[HeroStrategy("露娜", HeroAttribute.Agility)]
public sealed partial class 露娜Strategy : IHeroStrategy
{
